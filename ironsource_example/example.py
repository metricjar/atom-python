...
if __name__ == "__main__":
    ...
    data_post = [{"event_name": "PYTHON_SDK_BATCH_POST_EXAMPLE", "string_value": str(random.random())},
                 {"event_name": "PYTHON_SDK_BATCH_POST_EXAMPLE", "string_value": str(random.random())}]
